...
{
echo "<table style='border:4px; margin-left:200px; margin-right:200px; height:5px; width:940px; color:black;'>";
...
$p=mysqli_query($conn,"select * from student where E_no='$Eno' and Year='$year' and Semester='$sem'");
...
$p=mysqli_query($conn,"desc obtained_marks");
...
$p=mysqli_query($conn,"select Course_No,Subject_Name,Obtained_sem,Obtained_practical,Obtained_mid,Subject_total,Subject_grade_points,Subject_credit_points from obtained_marks where E_no='$Eno' and Year='$year' and Semester='$sem'");
while($a=mysqli_fetch_array($p))
{
...
$p=mysqli_query($conn,"select Total_credit,Total_credit_obtained,SGPA,OGPA from result where E_no='$Eno' and Year='$year' and Semester='$sem'");
...
$p=mysqli_query($conn,"select Backlog_details from result where E_no='$Eno' and Year='$year' and Semester='$sem'");
