...
<h2 align="center">Upload Student Record CSV File Format </h2>
<br><br>
		...
		while(($fileop = fgetcsv($handle,1000,","))!==false)
			{
				 ...
				 $sql=mysqli_query($conn,"INSERT INTO student(RollNo,E_no,Name,Fname,Mname,Year,Semester,Session,Department_name,College_name)values($fileop[0],'$fileop[1]','$fileop[2]','$fileop[3]','$fileop[4]','$fileop[5]','$fileop[6]','$fileop[7]','$fileop[8]','$fileop[9]')");
					$ct++;
				 if($sql)
						{
						if($err==0)
