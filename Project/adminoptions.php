...
<div style="background-image: url(im.jpg)">
    <br>
    <h1 style="text-align:center;color:blue;font-size:250%">MAHARANA PRATAP UNIVERSITY OF AGRICULTURE AND TECHNOLOGY</h1>
...
<center>
<div class='btn-group'>
  <button><a href='upload_data.php'>Upload Data</a></button><br>
  <button><a href='show_database_data.php'>Display all Database & Table Record</a></button>
</div>
</center>
